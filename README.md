...
- Performance Projections — Statistical models and projection sources used to forecast player output
- Research Notes — Deep dives on individual players, trends, and matchup data

Goals
- Identify high-upside, undervalued players before the draft
- Build a balanced roster with strong production across all scoring categories
